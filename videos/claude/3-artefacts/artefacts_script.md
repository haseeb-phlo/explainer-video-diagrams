...
**Format:** one flowing Excalidraw board you pan across and talk over, cutting to live Claude between them · ~5 min Loom · British English · invented design system (no company branding) · current to today.
...
Voice: warm, plain, a colleague showing you something useful - not a corporate voiceover. Times are a guide. `[BEAT n]` = the frame on screen. `[CUT TO CLAUDE DESKTOP]` / `[BACK TO BOARD]` = switch between the board and the live Claude window.

**[BEAT 1] 0:00 - 0:12 (Hook)**
...
**[BEAT 5] 1:25 - 1:35 (Handoff) → [CUT TO CLAUDE DESKTOP]**
"First, the one-pager. Watch the right-hand side."

**[CUT TO CLAUDE DESKTOP] 1:35 - 2:25 (Demo 1 - see Section 3.1)**
...
**[BACK TO BOARD] [BEAT 6] 2:25 - 2:55 (Iterate)**
...
**[BEAT 7] 2:55 - 3:05 (Handoff) → [CUT TO CLAUDE DESKTOP]**
"A supply calculator. Quantity in, daily dose in, days of supply and a reorder date out."

**[CUT TO CLAUDE DESKTOP] 3:05 - 3:55 (Demo 2 - see Section 3.2)**
...
**[BACK TO BOARD] [BEAT 8] 3:55 - 4:15 (Share - the unlock)**
"And that link is the part that matters for us. Build something once, publish it, drop the link in Slack - and the whole team uses it, no account needed to open it. The the support team reply-template one person perfects; the meeting-prep sheet anyone can grab; the reorder calculator ops keeps handy. One person's good idea becomes everyone's tool."

**[BEAT 9] 4:15 - 4:30 (New, light)**
...
**[BEAT 10] 4:30 - 4:45 (Rule + when not)**
"One rule, one reality check. The rule: publishing or connecting an Artifact changes who can see it, so keep anything confidential, and any logins or keys, out of anything you share. The reality check: a quick one-off answer doesn't need an Artifact. Reach for one when you'll reuse it, edit it, or hand it on."

**[BEAT 11] 4:45 - 4:55 (Pause and try)**
...
3. Iterate - type:
   ...
   (v2.)
4. Share it: click **Publish** (top-right of the Artifact panel) and **copy the link**. As you do, say the rule: "made-up numbers only - nothing confidential goes into anything I publish." Mention the link is version-specific and that all your shared Artifacts live in the **Published** tab.
...
- **Palette "Riso Workshop"** (warm paper, ink, vermilion, violet, mustard). Risograph-style colour suits Excalidraw's hand-drawn line, reads creative and energetic, and is deliberately **not** your brand palette, as you asked. Tight roles (violet = "things you can use", vermilion = "maker energy / caution", mustard = the pause only) keep it disciplined instead of rainbow.
