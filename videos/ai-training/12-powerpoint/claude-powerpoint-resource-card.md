...
> **Verified 2026-09-14, and RE-VERIFIED against the live docs on 2026-09-16** - the
> re-check found two errors in the enablement section and they are corrected below,
> marked CORRECTED 2026-09-16. Everything under "The
...
### Anthropic's own best practices, verbatim
...
The second is **beat 4 in Anthropic's own words**: hand it the template first, then ask.
