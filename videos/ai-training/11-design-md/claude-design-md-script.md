# Day 11: design.md - narration script (~7 min 10, Loom)

Board: `videos/ai-training/11-design-md/claude-design-md.excalidraw` (8 beats, one slot
each, `GAP = 800`). **Day 11** of the AI training series.
...
> when a Day 11 entry exists** - particularly the hook, the pause-and-try and the
> resource list.
