# Resource Card - Day 13: design.md

Paste this into the AI Ops Learn Resource Card for Day 13, alongside the Loom.

> **Three things to do before publishing this card.**
> 1. **There is no Day 13 entry in `Phlo_Mandatory_AI_Course_Curriculum.docx`**, so the
...
| **`CLAUDE.md` in a design project** | Standing instructions for **these designs** - written when you ask for feedback to be saved, and read before every new design in that project. | **Day 13, beat 6** |
...
- The board itself: `videos/ai-training/13-design-md/claude-design-md.excalidraw` - open
...
- **Day 10 - design work with Claude** - the judgement half. Reference beats adjectives,
  one element at a time, presentable is not correct. **Watch it first**; Day 13 makes its
  habits permanent.
...
- **Day 7 - Skills** - where "test on a known input" comes from. Day 13's catch is the
